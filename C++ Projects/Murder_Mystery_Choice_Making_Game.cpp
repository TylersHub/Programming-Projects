...
cout << "You finally find an area you're comfortable with and sit down. You have a couple of drinks and talk to the people in that area. An hour later you have the urge to go pee. What do you do?\n\n";
...
cout << "Your instincts tell you to check behind the shower curtain, so that's exactly what you do. Only to find a dead body laying in the tub! So you...\n\n";
...
switch(branch2_twig1){
  case 1:
    cout << "You go and ask a couple more questions and now you're more sure of who the suspect is but you're slightly hesitant.\n\n";
  break;
  case 2:
    cout << "You call the cops and have the suspect arrested. A few weeks later you find out the the suspect which you chose was actually not the killer...\n\n";
    cout << end2;
    return 0;
  break;
}

cout << "Now that you're completely sure, who is the suspect?\n\n";
...
switch(branch3){
  case 1:
    cout << "You think the Killer is Andrew so you have a few people keep a good eye on him while you calls the cops. He hands over his weapons and admits he was the Killer.\n\n";
    cout << end1;
  break;
  case 2:
    cout << "You tell everyone that you think Susan is the killer and she begins to have an argument with you. Then the real killer pulls out a gun and shoots both of you and runs out the place.\n\n";
    cout << end3;
  break;
  case 3:
    cout << "You think the Killer is Danny so you have a few people keep a good eye on him while you calls the cops. The cops arrive and arrest Danny, and take him to jail. But a few weeks later you hear that Danny turns out to be innocent and that someone else was the Killer.\n\n";
    cout << end2;
  break;
}
return 0;
